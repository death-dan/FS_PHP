...
$mbRepalce = $mbString . " Fui, iria novamente, e foi épico!";

var_dump([
    "mb_strlen" => mb_strlen($mbRepalce),
    "mb_strpos" => mb_strpos($mbRepalce, ", "),
    "mb_strrpos" => mb_strrpos($mbRepalce, ", "),
    "mb_substr" => mb_substr($mbRepalce, 40 + 2, 14),
    "mb_strstr" => mb_strstr($mbRepalce, ", ", true),
    "mb_strrchr" => mb_strrchr($mbRepalce, ", ", true)
]);
...
$endPoint = "name=José&email=blabla@blablas.com";
